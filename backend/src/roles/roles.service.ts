...
export class RolesService {
  constructor(
    ...
    private readonly permissionRepo1: Repository<PermissionEntity>,
  ...
  async addPermissionsToRole(dto: AddPermissionsToRoleDto, req: any) {
    ...
    await this.logsService.logAction(
      ...
      'Permission',
      user.user_id,
      `Has Changed the ${role.role_name} Permissions`,
    );
  ...
  async deleteRole(id: string, req: any) {
    ...
    await this.logsService.logAction(
      ...
      'Role',
      id,
      `Has Deleted the Role ${roleToDelete.role_name}`,
    );
