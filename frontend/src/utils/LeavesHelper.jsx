...
export const getUserLeaves = async (userId, currentPage, leavesPerPage) => {
  try {
    const response = await fetch(
      `http://localhost:5000/api/leaves/user/${userId}`,
      {
        method: "POST",
        credentials: "include",
        headers: {
...
export const getLeaves2 = async (
  ...
  try {
    const response = await fetch(
      `http://localhost:5000/api/leaves/getOtherLeaves/${userId}`,
      {
        method: "POST",
        credentials: "include",
        headers: {
...
export const changeLeaveStatus = async (
  ...
  try {
    const response = await fetch(
      `http://localhost:5000/api/leaves/changeState/${leaveId}`,
      {
        method: "PUT",
        credentials: "include",
        headers: {
