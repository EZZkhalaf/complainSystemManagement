...
//   return (
//     <div className="p-6 bg-gray-50 min-h-screen w-full">
//       <h2 className="text-3xl font-semibold mb-8 text-indigo-700 text-center">Activity Logs</h2>
...
//           onChange={(e)=> 
//             // e.preventDefault()
//             handleFilter(setUser)
//           }
//           className="px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-indigo-300 focus:outline-none"
//         />
...
//         <select
//           value={resource}
//           onChange={handleFilter(setResource)}
//           className="px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-indigo-300 focus:outline-none"
//         >
//           <option value="">All Resources</option>
//           <option value="User">User</option>
...
//                 <td className="px-6 py-4 border-b">{(currentPage - 1) * LOGS_PER_PAGE + index + 1}</td>
//                 <td className="px-6 py-4 border-b">{log?.user?.name || 'Unknown'}</td>
//                 <td className="px-6 py-4 border-b text-indigo-600 font-medium">{log?.action}</td>
//                 <td className="px-6 py-4 border-b">{log?.resource}</td>
//                 <td className="px-6 py-4 border-b">{log?.message}</td>
//                 <td className="px-6 py-4 border-b text-gray-500">
//                   {new Date(log?.timestamp).toLocaleString()}
...
//           onClick={() => handlePageChange('prev')}
//           disabled={currentPage === 1}
//           className="bg-indigo-500 hover:bg-indigo-600 text-white px-4 py-2 rounded disabled:bg-gray-300 transition"
//         >
//           Previous
//         </button>
